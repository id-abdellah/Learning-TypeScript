...
function showMyData(name: string, age: number, country: string = "morocco") {
...
function showMyData2(name: string, age: number, country?: string) {
    return `${name} - ${age} - ${country}`
}

console.log(showMyData2("mohamed", 20)); // "mohamed" - 20 - undefined
