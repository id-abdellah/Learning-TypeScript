...
class BarbarianCharacter extends Player {
    constructor(playerName, axeDurabillity) {
        super(playerName);
        this.axeDurabillity = axeDurabillity;
    }
    attack() {
        // super.attack()
...
console.log(barOne.playerName);
console.log(barOne.axeDurabillity);
barOne.attack();
barOne.attack();
barOne.attack();
console.log(barOne.axeDurabillity);
